...
export default function VendorResetPassword() {
  ...
  async function submit(e) {
    ...
    setLoading(true);
    try {
      await api.post('/vendors/password-reset/confirm', { token, password });
      setSuccess(true);
      setTimeout(() => {
        navigate('/');
      }, 3000);
      ...
      console.debug('Failed to reset vendor password', err?.message || err);
    } finally {
      setLoading(false);
    }
  }
        ...
        <div className="mx-auto max-w-md px-6">
          <div className="rounded-3xl bg-white/80 p-8 shadow-xl shadow-rose-100/60 backdrop-blur text-center">
            <div className="mb-6">
              ...
              <p className="text-slate-600">Your vendor account password has been successfully reset. You can now sign in with your new password.</p>
            </div>
      ...
      <div className="mx-auto max-w-md px-6">
        <div className="rounded-3xl bg-white/80 p-8 shadow-xl shadow-rose-100/60 backdrop-blur">
          <div className="mb-6">
            ...
            <h1 className="text-2xl font-bold text-slate-800">Reset Vendor Password</h1>
            <p className="mt-2 text-slate-600">Enter your new vendor account password below.</p>
          </div>
