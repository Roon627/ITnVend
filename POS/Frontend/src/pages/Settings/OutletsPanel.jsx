  ...
  const handleLogoFileChange = async (event) => {
    ...
    try {
      ...
      reader.onload = async () => {
        ...
        try {
          const json = await api.post("/settings/upload-logo", {
            filename: file.name,
            data: dataUrl,
          });
          const sanitizedUrl =
    ...
    <div className="bg-white p-6 rounded-md shadow space-y-6">
      <section className="space-y-2">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:items-center">
          ...
          <button
            ...
            title={
              isManager
                ? "Only administrators may create outlets"
                : "Create new outlet"
            }
            type="button"
          >
        ...
        <section className="p-4 bg-gray-50 rounded-lg border space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <select
              ...
              onChange={(e) =>
                setNewOutlet((p) => ({ ...p, currency: e.target.value }))
              }
            ...
            <input
              ...
              className="border px-3 py-2 rounded-md"
            />
            {/* spacer removed to avoid stray text nodes in some browsers */}
            <textarea
              placeholder="Store Address"
              value={newOutlet.store_address}
              onChange={(e) =>
                setNewOutlet((p) => ({ ...p, store_address: e.target.value }))
              }
            ...
            <div className="md:col-span-2 space-y-2">
              ...
              <p className="text-xs text-gray-500">
                Keep it short and sweet. This line appears on every generated
                invoice (plain text only).
              </p>
            </div>
          </div>
      ...
      <section className="space-y-4 pt-4 border-t">
        <h3 className="text-lg font-medium text-gray-800">
          {selectedOutletId
            ? `Editing ${formState.outlet_name || "Selected Outlet"}`
            : "Global Defaults"}
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="md:col-span-2">
            ...
            <p className="mt-1 text-xs text-slate-500">
              This short message prints at the bottom of generated invoices and
              quotes. Plain text only.
            </p>
            <textarea
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      updateField("payment_instructions", e.target.value)
                    }
                    className="mt-2 block w-full border rounded-md px-3 py-2 shadow-sm"
                    rows={2}
                  />
                  <p className="mt-1 text-xs text-slate-500">
                    A short note or payment instructions to appear at the bottom
                    of PDF invoices.
                  </p>
                </div>
                ...
                <div>
                  ...
                  />
                  <p className="mt-1 text-xs text-slate-500">
                    A short closing note to appear after payment instructions on
                    invoices (e.g. "Please keep this invoice as proof of
                    payment.").
                  </p>
                </div>
              </div>
          ...
          <div className="md:col-span-2 border-t pt-4">
            ...
            <p className="mt-1 text-xs text-slate-500">
              This logo appears on invoices, quotes, and default email
              templates. It is shared across all outlets.
            </p>
            <div className="mt-3 flex flex-col gap-3 sm:flex-row sm:items-center">
              ...
              <div className="flex flex-col gap-1">
                ...
                <p className="text-xs text-slate-500">
                  Upload a PNG, JPG, SVG, or GIF. Recommended size 512×512px or
                  larger with transparent background.
                </p>
                {!isAdmin && (
